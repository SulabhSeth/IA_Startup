...
export default function NewStartup() {
  const [form, setForm] = useState({ startup_Name: '', owner_first_name: '', owner_last_name: '', category: '', city: '',  state: '', zip: '', logInId: '', password: '',     });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        setForm({ startup_Name: '', owner_first_name: '', owner_last_name: '', category: '', city: '',  state: '', zip: '', logInId: '', password: '',    });
      } else {
  ...
  return (
    <div className="flex ml-96">
      <div>
        <Image className="h-72 w-88 opacity-50 mt-32" src=""></Image>
      </div>
      <div className="mt-12 ml-36 ">
        <form class="w-full max-w-lg" onSubmit={handleSubmit}>
          ...
          <div className="mt-8 ">
            <Image label="your image" name="image" />
          </div>
      ...
      <div>
        <Image className="h-72 w-88 opacity-50 mt-32 ml-8" src=""></Image>
      </div>
    </div>
  );
}
